...
void checkCategoriesAndQuotes(WebDriver driver) {
	...
	final String exp_cat_fam = "Famous Quotes";
	final String exp_cat_awe = "Awesome Quotes";
	
	/*Expected quotes*/
	final String[] array_awesome = [
	...
	/*Gather awesome quotes as web elements*/
	WebElement labelAwe = driver.findElement(By.xpath("//body/ul/li/strong[text()='"+exp_cat_awe+"']"))
	WebElement parentAwe = labelAwe.findElement(By.xpath(".."))
	ArrayList<WebElement> aweElements = parentAwe.findElements(By.xpath(".//li"))
	println("No of awesome quotes:" +aweElements.size())

	/*Gather famous quotes as web elements*/
	WebElement labelFam = driver.findElement(By.xpath("//body/ul/li/strong[text()='"+exp_cat_fam+"']"))
	WebElement parentFam = labelFam.findElement(By.xpath(".."))
	ArrayList<WebElement> famElements = parentFam.findElements(By.xpath(".//li"))
	println("No of famous quotes:" +famElements.size())

	/*Get strings from web elements representing quotes*/
	ArrayList<String> awe_strings = new ArrayList<String>()
	ArrayList<String> fam_strings = new ArrayList<String>()
	
	for (WebElement we_awe:aweElements) {
	...
	for (WebElement we_fam:famElements) {
